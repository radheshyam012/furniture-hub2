...
class AdminServices {
  void sellProduct({
    ...
    try {
      final cloudinary = CloudinaryPublic('dcehoyjuc', 'nnabyi0k');
      List<String> imgUrls = [];
      ...
      httpErrorHandle(
        ...
        onSuccess: () {
          ...
          sales = [
            ...
            Sales('Cabinets', response['cabinetsEarnings']),
            Sales('Sofas', response['sofasEarnings']),
            Sales('Armchairs', response['armchairsEarnings']),
            Sales('Storage', response['storageUnitsEarnings']),
            // Sales('Desks', response['desksEarnings']),
            // Sales('Tables', response['tablesEarnings']),
            // Sales('Cupboard', response['cupboardEarnings']),
          ];
        },
      );
    } catch (e) {
